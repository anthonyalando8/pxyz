...
func GetDefaultModules() ([]*Module, []*Submodule, error) {
	...
	modules := []*Module{
		...
		{Code: "rbac", Name: "RBAC", IsActive: true, CreatedAt: now, CreatedBy: createdBy, Meta: marshalMeta(nil, nil)},
	}
...
func GetDefaultRolesAndPermissions() ([]*PermissionType, []*Role, []*RolePermission, error) {
	...
	roles := []*Role{
		{Name: "super_admin", Description: "A super admin of the system", IsActive: true, CreatedAt: now, CreatedBy: createdBy},
		{Name: "admin", Description: "A normal admin", IsActive: true, CreatedAt: now, CreatedBy: createdBy},
		{Name: "pending", Description: "A pending user with limited access", IsActive: true, CreatedAt: now, CreatedBy: createdBy},
	}
