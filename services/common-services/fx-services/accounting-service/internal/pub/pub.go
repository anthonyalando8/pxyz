...
func (p *TransactionEventPublisher) PublishTransactionCompleted(ctx context.Context, userID, receiptCode string, transactionID int64, transactionType, currency string, amount, balanceAfter, fee int64) error {
...
func (p *TransactionEventPublisher) PublishTransactionFailed(ctx context.Context, userID, receiptCode string, transactionID int64, transactionType, currency string, amount int64, errorMsg string) error {
	return p.PublishTransactionEvent(ctx, &TransactionEvent{
...
func (p *TransactionEventPublisher) PublishDepositCompleted(ctx context.Context, userID, receiptCode, accountNumber string, amount int64, currency string, balanceAfter int64) error {
	return p.PublishTransactionEvent(ctx, &TransactionEvent{
...
func (p *TransactionEventPublisher) PublishWithdrawalCompleted(ctx context.Context, userID, receiptCode, accountNumber string, amount int64, currency string, balanceAfter int64) error {
	return p.PublishTransactionEvent(ctx, &TransactionEvent{
...
func (p *TransactionEventPublisher) PublishTransferCompleted(ctx context.Context, userID, receiptCode, fromAccount, toAccount string, amount int64, currency string, fee int64) error {
	return p.PublishTransactionEvent(ctx, &TransactionEvent{
