...
type Agent struct {
	...
	// ✅ NEW FIELDS
	CommissionRateForDeposit *decimal.Decimal       `json:"commission_rate_for_deposit,omitempty"`
	PaymentMethod            *string                `json:"payment_method,omitempty"`
	Location                 map[string]bool        `json:"location,omitempty"` // Country codes:  {"KE": true, "UG": false}
