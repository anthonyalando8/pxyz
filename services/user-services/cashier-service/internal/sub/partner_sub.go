// user-service/internal/events/subscriber. go
package subscriber
...
func (s *EventSubscriber) Start(ctx context.Context) error {
	pubsub := s.rdb.Subscribe(ctx, ChannelDepositCompleted, ChannelDepositFailed)
	defer pubsub.Close()
	...
	s.logger.Info("event subscriber started",
		zap. Strings("channels", []string{ChannelDepositCompleted, ChannelDepositFailed}))
