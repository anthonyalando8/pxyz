...
func (x *GetUserRolesPermissionsRequest) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *GetUserRolesPermissionsResponse) GetRoles() []string {
	if x != nil {
		return x.Roles
	}
	return nil
...
func (x *GetUserRolesPermissionsResponse) GetPermissions() []string {
	if x != nil {
...
const file_proto_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x15proto/auth/auth.proto\x12\x04auth\"\x97\x01\n" +
	...
	"\vpermissions\x18\x04 \x03(\tR\vpermissions\"\xf4\x03\n" +
	"\x04User\x12\x0e\n" +
	...
	"\faddress_json\x18\x10 \x01(\tR\vaddressJson2\x89\x02\n" +
	"\vAuthService\x12E\n" +
	...
	"\x17GetUserRolesPermissions\x12$.auth.GetUserRolesPermissionsRequest\x1a%.auth.GetUserRolesPermissionsResponseB\x18Z\x16genproto/authpb;authpbb\x06proto3"
...
var file_proto_auth_auth_proto_goTypes = []any{
	...
	(*GetUserRolesPermissionsRequest)(nil),  // 4: auth.GetUserRolesPermissionsRequest
	(*GetUserRolesPermissionsResponse)(nil), // 5: auth.GetUserRolesPermissionsResponse
	(*User)(nil),                            // 6: auth.User
}
var file_proto_auth_auth_proto_depIdxs = []int32{
	6, // 0: auth.GetUserProfileResponse.user:type_name -> auth.User
	...
	4, // 3: auth.AuthService.GetUserRolesPermissions:input_type -> auth.GetUserRolesPermissionsRequest
	...
	5, // 6: auth.AuthService.GetUserRolesPermissions:output_type -> auth.GetUserRolesPermissionsResponse
