...
const file_proto_session_session_proto_rawDesc = "" +
	...
	"\bsessions\x18\x01 \x03(\v2\x10.session.SessionR\bsessions\"9\n" +
	"\x18DeleteSessionByIDRequest\x12\x1d\n" +
	"\n" +
	"session_id\x18\x01 \x01(\tR\tsessionId\"\a\n" +
	"\x05Empty2\xb8\x04\n" +
	"\vAuthService\x12T\n" +
	"\x0fValidateSession\x12\x1f.session.ValidateSessionRequest\x1a .session.ValidateSessionResponse\x12N\n" +
	"\rCreateSession\x12\x1d.session.CreateSessionRequest\x1a\x1e.session.CreateSessionResponse\x12f\n" +
	"\x15UpdateSessionActivity\x12%.session.UpdateSessionActivityRequest\x1a&.session.UpdateSessionActivityResponse\x12>\n" +
	"\rDeleteSession\x12\x1d.session.DeleteSessionRequest\x1a\x0e.session.Empty\x12F\n" +
	"\x11DeleteAllSessions\x12!.session.DeleteAllSessionsRequest\x1a\x0e.session.Empty\x12K\n" +
	"\fListSessions\x12\x1c.session.ListSessionsRequest\x1a\x1d.session.ListSessionsResponse\x12F\n" +
	"\x11DeleteSessionByID\x12!.session.DeleteSessionByIDRequest\x1a\x0e.session.EmptyB\x1eZ\x1cgenproto/sessionpb;sessionpbb\x06proto3"
...
var file_proto_session_session_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_proto_session_session_proto_goTypes = []any{
	...
	(*DeleteSessionRequest)(nil),          // 5: session.DeleteSessionRequest
	(*DeleteAllSessionsRequest)(nil),      // 6: session.DeleteAllSessionsRequest
	(*ValidateSessionRequest)(nil),        // 7: session.ValidateSessionRequest
	(*ValidateSessionResponse)(nil),       // 8: session.ValidateSessionResponse
	(*ListSessionsRequest)(nil),           // 9: session.ListSessionsRequest
